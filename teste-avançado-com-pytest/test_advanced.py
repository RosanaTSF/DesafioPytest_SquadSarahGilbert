...
# Fixture que cria o arquivo temporário usando o tmpdir do pytest
@pytest.fixture
def tmpfile(tmpdir):
    def write():
...
class TestFile:
    ...
    # Teste que usa a fixture para verificar o conteúdo do arquivo
    ...
    # Outro teste que também utiliza o arquivo temporário
